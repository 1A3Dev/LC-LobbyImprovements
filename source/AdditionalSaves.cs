...
namespace LobbyImprovements
{
    ...
    public class AdditionalSaves
    {
        ...
        private static void MM_Start(MenuManager __instance)
        {
            ...
            //foreach (SaveFileUISlot file in array)
            //{
            //    if (file.fileNum != -1 && file.fileNum != 0)
            //    {
            //        GameObject.Destroy(file.gameObject);
            //    }
            //}
            ...
            //    int fileNum = int.Parse(file.Substring("LCSaveFile".Length));
